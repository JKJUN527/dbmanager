...
@section('custom-script')
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(result.status == 200){
                        ...
                        var voltage = "select[name=voltage] option:contains("+"'"+result.data.voltage +"')";
                        var electric = "select[name=electric] option:contains("+"'"+result.data.electric +"')";
                        $(vender).attr('selected', true);
                        $(region).attr('selected', true);
                        $(voltage).attr('selected', true);
                        $(electric).attr('selected', true);
        ...
        $("#search_tablenum").click(function () {
            ...
            $(location).attr('href', "/db/table2?tablenum=" + table_num);
        });
