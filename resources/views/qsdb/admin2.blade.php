...
@section('content')
    <div class="container body">
        <div class="main_container">
            {{--@section('index-nav')--}}
                @include('components.indexNav',['activeIndex'=>1,'activeIndexSecend'=>1])
            {{--@endsection--}}
{{--            @section('header-nav')--}}
                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                        <div class="x_title">
                                            <h2>户表厂家管理 <small>在这里新增修改户表厂家设置</small></h2>
