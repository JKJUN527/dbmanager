                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped jambo_table bulk_action">
                                                ...
                                                <tbody>
                                                @foreach($data['products_module'] as $item)
                                                    <tr class="even pointer">
                                                        <td class=" ">{{$item->productName}}({{$item->productDesc}})</td>
                                                        <td class=" ">{{$item->moduleName}}</td>
                                                        <td class=" ">{{$item->modulePrincipal}}</td>
                                                        <td class=" ">{{$item->createTime}}</td>
                                                        <td class=" ">
                                                            <button type="button" data-content="{{$item->moduleId}}" class="btn btn-round btn-primary" name="modify">修改</button>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control show-tick selectpicker" id="products" name="products">
                               @foreach($data['products'] as $item)
                                    <option value="{{$item->productId}}">{{$item->productName}}({{$item->productDesc}})</option>
                                @endforeach
