            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li @if($activeIndex == 0) class="active" @endif>
                        ...
                        <ul class="nav child_menu">
                            <li @if($activeIndexSecend == 0) class="current-page" @endif><a href="/db/table1">集中器/采集器</a></li>
                            <li @if($activeIndexSecend == 1) class="current-page" @endif><a href="/db/table2">户表</a></li>
                            <li @if($activeIndexSecend == 2) class="current-page" @endif><a href="/db/table3">低压互感器</a></li>
                            <li @if($activeIndexSecend == 3) class="current-page" @endif><a href="/db/table4">高压互感器</a></li>
                            <li @if($activeIndexSecend == 4) class="current-page" @endif><a href="/db/table5">组合式互感器</a></li>
                            <li @if($activeIndexSecend == 5) class="current-page" @endif><a href="/db/table6">计量箱</a></li>
